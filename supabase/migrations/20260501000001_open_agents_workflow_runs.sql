...
-- session_id / account_id intentionally omitted: derivable via
-- chat -> session -> account joins. Keeping only chat_id eliminates
-- a class of cross-ownership inconsistency that independent FKs allow.
